...
#define CALL_send_fld2_clm(pressure, saturation, topo, ix, iy, nx, ny, nz, nx_f, ny_f, pstep, porosity, dz, h2osoi_liq) \
        send_fld2_clm(pressure, saturation, topo, &ix, &iy, &nx, &ny, &nz, &nx_f, &ny_f, &pstep, porosity, dz, h2osoi_liq)
void send_fld2_clm(double *pressure, double *saturation, double *topo, int *ix, int*iy,
                   int *nx, int *ny, int *nz, int *nx_f, int *ny_f, double *pstep, double *porosity, double *dz, double *h2osoi_liq);
